import { DatePicker as MuiDatePicker, DateTimePicker as MuiDateTimePicker, LocalizationProvider, DatePickerProps as MuiDatePickerProps, DateTimePickerProps as MuiDateTimePickerProps, DateValidationError, PickerChangeHandlerContext, DateTimeValidationError } from "@mui/x-date-pickers";
...
export function DatePicker<T extends DatePickerVariants>({ variant, slots, slotProps, required = false, onChange, ...datePickerProps } : Props<T>) {
  ...
  let pickerProps = {};
	...
	const handleDateChange = (newDate: Dayjs | null, context: PickerChangeHandlerContext<DateValidationError | DateTimeValidationError>) => {
