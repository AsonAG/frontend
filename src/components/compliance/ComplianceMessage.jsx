		...
		<Stack component={Paper} spacing={1} p={2}>
			...
			<Stack direction="row" spacing={3} flexWrap="wrap">
				<MessageLink
					...
					setDocumentPromise={setDocumentPromise}
				/>
				<MessageLink
					name={t("Response")}
				...
				{message.encryptedRequest && (
					<MessageLink
						name={t("Encrypted request")}
						content={message.encryptedRequest}
						setDocumentPromise={setDocumentPromise}
					/>
				)}
				{message.encryptedResponse && (
					<MessageLink
						name={t("Encrypted response")}
						content={message.encryptedResponse}
						setDocumentPromise={setDocumentPromise}
					/>
				)}
			</Stack>
			{documentPromise && (
				<DocumentDialog
					...
					onClose={() => setDocumentPromise(null)}
				/>
			)}
		</Stack>
	);
