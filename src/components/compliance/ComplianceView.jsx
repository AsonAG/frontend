...
export function ComplianceView() {
  ...
  var button = showButton && <IconButton LinkComponent={Link} to="settings"><Settings /></IconButton>;
  return (
    <ContentLayout title={t("Compliance")} height="100%" buttons={button}>
      <Stack spacing={3}>
        ...
        <ComplianceItemView dataPromise={routeData.documents} path="documents">
          <ComplianceItemCard to="documents/new" title={t("New document")} Icon={Add}/>
        </ComplianceItemView>
        <Typography variant="h6">{t("Submissions")}</Typography>
        <ComplianceItemView dataPromise={routeData.submissions} path="submissions" Icon={Summarize}/>
