...
export const getInputCaseKey = (_case) => "case_" + _case.name + "_" + _case.id;
export const getOutputCaseKey = (_case) => "case_" + _case.caseName + "_" + _case.id;
