...
export function FieldPeriodSelector({ field }) {
  ...
  const periodPickers = <>
    <FieldValueDateComponent propertyName="start" displayName={t("Start")} required={!field.optional} />
    {
      field.timeType !== "Moment" &&
       <FieldValueDateComponent propertyName="end" displayName={t("End")} required={!field.optional && field.endMandatory} />
    }
  </>;
