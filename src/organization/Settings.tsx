	...
	return (
		<Stack spacing={2}>
			<Stack direction="row" alignItems="center">
				<Typography flex={1}>
					{t("Export the data of the organization")}
				</Typography>
				<Button
					variant="outlined"
					color="primary"
...
function DeleteOrganizationDialogContent({ org, onDelete }) {
	...
	return (
		<ResponsiveDialogContent>
			...
			<Typography>
				{t("delete_organization_description", { orgName: org.identifier })}
			</Typography>
...
function useAction(
	actionName: string,
): [() => void, boolean, JSX.Element | undefined] {
	...
	if (
		...
		navigation.formData?.get("intent") === actionName
	) {
		icon = (
			<CircularProgress
				size="1rem"
