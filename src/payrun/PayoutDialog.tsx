...
export function PayoutDialog({
	...
	const { bankAccountDetails } = useRouteLoaderData(
		"payrunperiod",
	...
	const [bankAccount, setBankAccount] =
		useState<BankAccountDetails>(bankAccountDetails);
					...
					<Stack spacing={2}>
						...
						<Box sx={dialogColumns}>
							...
							<DatePicker
								...
								disablePast
								value={valueDate}
								onChange={(v) => setValueDate(v)}
								onError={(e) => setValueDateValid(!e)}
							></DatePicker>
						</Box>
						<Stack direction="row" justifyContent="end" spacing={2}>
							...
							<Button
								disabled={!valueDate || !valueDateValid || !bankAccount?.iban}
								loading={submitting}
								variant="contained"
								onClick={() =>
									onPayout(valueDate!.toISOString(), bankAccount.iban!)
								}
							>
								{t("Confirm")}
							</Button>
