...
function SalaryTypeSection() {
	...
	const { salaryTypesSet } = useRouteLoaderData(
		"payrunperiod",
	...
	const handleChange = (event: React.ChangeEvent<HTMLInputElement>) => {
		...
		dispatch({
			...
			salaryType: value === "all" ? null : value,
		});
	};
	...
	return (
		<FormControl>
			...
			<RadioGroup value={state.salaryType ?? "all"} onChange={handleChange}>
...
export function useSalaryTypeFilterAtom(
