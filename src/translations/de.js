const translations = {
	translation: {
		...
		"Organization unit created, but setting regulations failed": "Organisationseinheit erstellt, aber das Setzen der Regelwerke ist fehlgeschlagen",
		"Create of organization unit failed": "Erstellen der Organisationseinheit fehlgeschlagen",
		"Organization unit updated, but setting regulations failed": "Organisationseinheit aktualisiert, aber das Setzen der Regelwerke ist fehlgeschlagen",
		...
		"delete_organization_description": "Sie sie sicher, dass Sie die Organisation '{{orgName}}' permanent löschen wollen?",
		...
		"expired": "abgelaufen",
		"external": "Extern",
		"This user is not assigned to an employee of the organization": "Dieser Benutzer ist keinem Miterarbeiter der Organisation zugeordnet",
