const translations = {
	...
	translation: {
		...
		delete_document_text:
			"Do you really want to delete the document '{{documentName}}'?",
		import_organization_button: "Import {{fileName}}",
		delete_organization_description:
			"Are you sure you want to permanently delete the organization '{{orgName}}'?",
		confirm_organization_deletion:
			"Please confirm by typing the name of the organization",
